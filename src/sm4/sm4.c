...
_asmweak void sm4_setkey_core(u32 *rk, const u8 *key){
    // keyscdule
    register u32 buf;
...
_asmweak void sm4_enc_core(u8 *out, const u8 *in, const u32 *rk) {
    register u32 buf;
...
_asmweak void sm4_dec_core(u8 *out, const u8 *in, const u32 *rk) {
    register u32 buf;
    register u32 r0 = GET32(in);
    register u32 r1 = GET32(in + 4);
    register u32 r2 = GET32(in + 8);
