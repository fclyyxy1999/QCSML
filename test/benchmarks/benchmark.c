...
static char test_vector0[] = "3945208F7B2144B13F36E38AC6D39F95889393692860B51A42FB81EF4DF7C5B8";
static char test_vector1[] = "E7BA3D4240D179AA38C580FFF968EE2EDB4A8EF6CF64E30A4B770A0CC69020ED";
static char test_vector2[] = "9DDD52AF95B748A553D1B1E106627F901CD453F067A0D50202C672130C90F607";
static char test_vector3[] = "421DEBD61B62EAB6746434EBC3CC315E32220B3BADD50BDC4C4E6C147FEDD43D";
static char test_vector4[] = "0680512BCBB42C07D47349D2153B70C4E5D7FDFCBFA36EA1A85841B9E46E09A2";
static char test_vector5[] = "04EBFC718E8D1798620432268E77FEB6415E2EDE0E073C0F4F640ECD2E149A73";
static char test_vector6[] = "E858F9D81E5430A57B36DAAB8F950A3C64E6EE6A63094D99283AFF767E124DF0";

int kat_fp(void){
    int ret = 1;
    sm2_fp x, y, t, r;
    sm2_fp_from_str(x, test_vector1);
    sm2_fp_from_str(y, test_vector2);
    ...
    // sm2_fp_sub
    sm2_fp_from_str(r, "B623156C54E5CEFB1B0C30E10CF991614189C4F8983BF1F8B74F68064600D519");
    sm2_fp_sub(t, y, x);
    ret &= sm2_fp_equ(t, r);
    ...
    // sm2_fp_haf
    sm2_fp_from_str(r, "F3DD1EA0A068BCD51C62C07FFCB477176DA5477AE7B27185A5BB850663481076");
    sm2_fp_haf(t, x);
    ret &= sm2_fp_equ(t, r);
...
int kat_fn(void){
    ...
    // sm2_fn_sub
    sm2_fp_from_str(r, "B623156C54E5CEFB1B0C30E10CF99160B38DA464BA01F7230B0B5C0F7FD6163D");
    sm2_fn_sub(t, y, x);
    ret &= sm2_fp_equ(t, r);
...
int kat_point(void){
    ...
    sm2_apoint t, r;
    sm2_jpoint a, b, c, d;
    sm2_fp_from_str(k, test_vector0);
    sm2_fp_from_str(a.x, test_vector1);
    sm2_fp_from_str(a.y, test_vector2);
    sm2_fp_set(a.z, sm2_one);
    sm2_fp_from_str(b.x, test_vector3);
    sm2_fp_from_str(b.y, test_vector4);
    sm2_fp_set(b.z, sm2_one);
    sm2_fp_from_str(c.x, test_vector5);
    sm2_fp_from_str(c.y, test_vector6);
    sm2_fp_set(c.z, sm2_one);
    ...
    sm2_jpoint_add(&d, &a, &b);
    sm2_jpoint_to_apoint(&d, &t);
    ret &= sm2_fp_equ(t.x, r.x) & sm2_fp_equ(t.y, r.y);
    ...
    sm2_jpoint_mdo(&d, 6, &b);
    sm2_jpoint_to_apoint(&d, &t);
    ret &= sm2_fp_equ(t.x, r.x) & sm2_fp_equ(t.y, r.y);

    // sm2_jpoint_gen
    sm2_apoint_from_str(&r, "09F9DF311E5421A150DD7D161E4BC5C672179FAD1833FC076BB08FF356F35020"
    ...
    // sm2_jpoint_mul
    sm2_apoint_from_str(&r, "335E18D751E51F040E27D468138B7AB1DC86AD7F981D7D416222FD6AB3ED230D"
                            "AB743EBCFB22D64F7B6AB791F70658F25B48FA93E54064FDBFBED3F0BD847AC9");
    sm2_jpoint_mul(&d, k, &c);
    sm2_jpoint_to_apoint(&d, &t);
    ret &= sm2_fp_equ(t.x, r.x) & sm2_fp_equ(t.y, r.y);
...
int kat_sm3(void){
    ...
    u8 digest1[32];
    u8 rdigest1[32];
    bytes_from_str(rdigest1, "66C7F0F462EEEDD9D1F2D46BDC10E4E24167C4875CF2F7A2297DA02B8F4BA8E0", 32);
    ...
    u8 digest2[32];
    u8 rdigest2[32];
    bytes_from_str(rdigest2, "DEBE9FF92275B8A138604889C18E5A4D6FDB70E5387E5765293DCBA39C0C5732", 32);
...
int kat_sm2_sig(void) {
    ...
    bytes_from_str(sig0, "3046022100f5a03b0648d2c4630eeac513e1bb81a15944da3827d5b74143ac7eaceee720b3022100b1b6aa29df212fd8763182bc0d421ca1bb9038fd1f7f42d4840b69c485bbc1aa", 72);
...
int kat_sm2_enc(void) {
    ...
    bytes_from_str(ct0, "307c022004ebfc718e8d1798620432268e77feb6415e2ede0e073c0f4f640ecd"
...
timestart_func time_start = NULL;
timeend_func time_end = NULL;

void time_reg(const timestart_func s, const timeend_func e){
    time_start = s;
    time_end = e;
}

void pb_fp_add(PBUint *u, const u32 count){
    sm2_fp x, y, z, r;
    sm2_fp_from_str(x, test_vector1);
    sm2_fp_from_str(y, test_vector2);
    sm2_fp_from_str(z, test_vector5);
    ...
    u->time = time_end();
    u->count = count;
    u->speed = (count << 1) / u->time;
    strcpy(u->name, "fp_add");
    strcpy(u->unit, "opt");
}

void pb_fp_sub(PBUint *u, const u32 count){
    sm2_fp x, y, z, r;
    sm2_fp_from_str(x, test_vector1);
    sm2_fp_from_str(y, test_vector2);
    sm2_fp_from_str(z, test_vector5);
    ...
    u->count = count;
    u->speed = (count << 1) / u->time;
    strcpy(u->name, "fp_sub");
    strcpy(u->unit, "opt");
}

void pb_fp_haf(PBUint *u, const u32 count){
    sm2_fp x, y, r;
    sm2_fp_from_str(x, test_vector1);
    sm2_fp_sub(y, x, sm2_one);
    ...
    u->count = count;
    u->speed = (count << 1) / u->time;
    strcpy(u->name, "fp_haf");
    strcpy(u->unit, "opt");
}

void pb_fp_dbl(PBUint *u, const u32 count){
    sm2_fp x, y, r;
    sm2_fp_from_str(x, test_vector1);
    sm2_fp_from_str(y, test_vector4);
    ...
    u->count = count;
    u->speed = (count << 1) / u->time;
    strcpy(u->name, "fp_dbl");
    strcpy(u->unit, "opt");
}

void pb_fp_mul(PBUint *u, const u32 count){
    sm2_fp x, y, r;
    sm2_fp_from_str(x, test_vector1);
    sm2_fp_from_str(y, test_vector2);
    ...
    u->time = time_end();
    u->count = count;
    u->speed = count / u->time;
    strcpy(u->name, "fp_mul");
    strcpy(u->unit, "opt");

}

void pb_fp_sqr(PBUint *u, const u32 count){
    sm2_fp x, r;
    sm2_fp_from_str(x, test_vector1);
    ...
    u->count = count;
    u->speed = count / u->time;
    strcpy(u->name, "fp_sqr");
    strcpy(u->unit, "opt");
}

void pb_fp_inv(PBUint *u, const u32 count){
    sm2_fp x, r;
    sm2_fp_from_str(x, test_vector1);
    ...
    u->count = count;
    u->speed = count / u->time;
    strcpy(u->name, "fp_inv");
    strcpy(u->unit, "opt");
}

void pb_point_add(PBUint *u, const u32 count){
    sm2_jpoint p, q, r;
    sm2_fp_from_str(p.x, test_vector1);
    sm2_fp_from_str(p.y, test_vector2);
    sm2_fp_set(p.z, sm2_one);
    sm2_fp_from_str(q.x, test_vector3);
    sm2_fp_from_str(q.y, test_vector4);
    sm2_fp_set(q.z, sm2_one);
    time_start();
    for (u32 i = count; i > 0; i--)
        sm2_jpoint_add(&r, &p, &q);
    u->time = time_end();
    u->count = count;
    u->speed = count / u->time;
    strcpy(u->name, "jpoint_add");
    strcpy(u->unit, "opt");
}
...
void pb_japoint_add(PBUint *u, u32 count){
    ...
    time_start();
    for (u32 i = count; i > 0; i--)
        sm2_japoint_add(&r, &p, &q);
    u->time = time_end();
    u->count = count;
    u->speed = count / u->time;
    strcpy(u->name, "japoint_add");
    strcpy(u->unit, "opt");
}

void pb_point_dbl(PBUint *u, const u32 count){
    sm2_jpoint p, r;
    sm2_fp_from_str(p.x, test_vector1);
    sm2_fp_from_str(p.y, test_vector2);
    sm2_fp_set(p.z, sm2_one);
    ...
    u->count = count;
    u->speed = count / u->time;
    strcpy(u->name, "jpoint_dbl");
    strcpy(u->unit, "opt");
}

void pb_point_mdo(PBUint *u, const u32 count){
    sm2_jpoint p, r;
    sm2_fp_from_str(p.x, test_vector1);
    sm2_fp_from_str(p.y, test_vector2);
    sm2_fp_set(p.z, sm2_one);
    time_start();
    for (u32 i = count; i > 0; i--)
        sm2_jpoint_mdo(&r, 6, &p);
    u->time = time_end();
    u->count = count;
    u->speed = count / u->time;
    strcpy(u->name, "jpoint_mdb");
    strcpy(u->unit, "opt");
}

void pb_point_mul(PBUint *u, const u32 count){
    sm2_fp k;
    sm2_jpoint p, r;
    sm2_fp_from_str(k, test_vector0);
    sm2_fp_from_str(p.x, test_vector1);
    ...
    time_start();
    for (u32 i = count; i > 0; i--)
        sm2_jpoint_mul(&r, k, &p);
    u->time = time_end();
    u->count = count;
    u->speed = count / u->time;
    strcpy(u->name, "jpoint_mul");
    strcpy(u->unit, "opt");
}

void pb_point_gen(PBUint *u, const u32 count){
    sm2_fp k;
    sm2_jpoint r;
    sm2_fp_from_str(k, test_vector0);
    ...
    u->count = count;
    u->speed = count / u->time;
    strcpy(u->name, "jpoint_gen");
    strcpy(u->unit, "opt");
}

void pb_sm2_sig(PBUint *u, const u32 count){
    sm2_prikey prikey;
    ...
    rand_pad("3945208F7B2144B13F36E38AC6D39F95889393692860B51A42FB81EF4DF7C5B8", 32);
    sm2_keygen(&prikey);
    time_start();
    for (u32 i = count; i > 0; i--)
    ...
    u->count = count;
    u->speed = count / u->time;
    strcpy(u->name, "sm2_sign");
    strcpy(u->unit, "opt");
}

void pb_sm2_vfy(PBUint *u, const u32 count){
    sm2_prikey prikey;
    sm2_signature signature;
    u8 dgst[32] = {0xF0, 0xB4, 0x3E, 0x94, 0xBA, 0x45, 0xAC, 0xCA, 0xAC, 0xE6, 0x9E, 0xD5,
                   0x48, 0xB6, 0xBA, 0xC1, 0xF4, 0x48, 0x6F, 0xDF, 0xC0, 0xD2, 0x86, 0x40};
    ...
    time_start();
    for (u32 i = count; i > 0; i--)
        sm2_verify_core(&signature, &prikey.pubkey, dgst);
    u->time = time_end();
    u->count = count;
    u->speed = count / u->time;
    strcpy(u->name, "sm2_verify");
    strcpy(u->unit, "opt");
}

void pb_sm2_enc(PBUint *u, const u32 count){
    ...
    u->count = count;
    u->speed = count / u->time;
    strcpy(u->name, "sm2_enc");
    strcpy(u->unit, "opt");
}

void pb_sm2_dec(PBUint *u, const u32 count){
    char msg[] = "encryption standard";
    u8 ciptext[126];
    sm2_prikey prikey;
    sm2_prikey_from_str(&prikey, "3945208F7B2144B13F36E38AC6D39F95889393692860B51A42FB81EF4DF7C5B8");
    bytes_from_str(ciptext,  "307c022004ebfc718e8d1798620432268e77feb6415e2ede0e073c0f4f640ecd2e149a73022100e858f9d81e5430a57b3"
    ...
    u->count = count;
    u->speed = count / u->time;
    strcpy(u->name, "sm2_dec");
    strcpy(u->unit, "opt");

}

void pb_sm3(PBUint *u, const u32 count){
    const u8 message[64] = "abcdefghijklmn";
    u32 digest[8] = {0};
    time_start();
    for (u32 i = count; i > 0; i--) {
        sm3_compress(digest, message, 1);
    }
    u->time = time_end();
    u->count = count;
...
void pb_sm4_dec(PBUint *u, const u32 count){
    const u8 key[16] = {0};
    u8 pt[16] = {0};
    u8 ct[16] = {0};
    sm4_ctx *ctx = malloc(sizeof(sm4_ctx));
